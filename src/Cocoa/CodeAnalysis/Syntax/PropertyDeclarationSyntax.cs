...
namespace Cocoa.CodeAnalysis.Syntax
{
    ...
    {
        internal PropertyDeclarationSyntax(SyntaxTree syntaxTree, ImmutableArray<SyntaxToken> modifiers, SyntaxToken propertyKeyword, SyntaxToken identifier, TypeClauseSyntax type, SyntaxToken openBraceToken, PropertyAccessorSyntax? getter, PropertyAccessorSyntax? setter, SyntaxToken closeBraceToken)
