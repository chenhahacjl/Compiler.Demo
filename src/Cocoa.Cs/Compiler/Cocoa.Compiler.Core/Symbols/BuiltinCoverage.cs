...
namespace Cocoa.CodeAnalysis.Symbols
{
    ...
    public static class BuiltinCoverage
    {
        private static readonly ImmutableArray<BuiltinCoverageRow> Rows = ImmutableArray.Create<BuiltinCoverageRow>(
            ...
            new(BuiltinKind.StringFromBytes, BuiltinBackend.All, null),
            new(BuiltinKind.StringToBytes, BuiltinBackend.All, null),
            new(BuiltinKind.FileReadAllBytes, BuiltinBackend.All, null),
            new(BuiltinKind.FileOpen, BuiltinBackend.All, null),
            new(BuiltinKind.FileSize, BuiltinBackend.All, null),
            new(BuiltinKind.FileSeek, BuiltinBackend.All, null),
            new(BuiltinKind.FileTell, BuiltinBackend.All, null),
            new(BuiltinKind.FileRead, BuiltinBackend.All, null),
            new(BuiltinKind.FileWrite, BuiltinBackend.All, null),
            new(BuiltinKind.FileClose, BuiltinBackend.All, null),
