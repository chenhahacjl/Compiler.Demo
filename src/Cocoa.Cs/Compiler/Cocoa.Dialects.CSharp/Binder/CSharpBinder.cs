...
namespace Cocoa.CodeAnalysis.CSharp.Binding
{
    ...
    public sealed partial class CSharpBinder : IBinder
    {
        ...
        private readonly Func<string, TypeSymbol?> _builtinTypeResolver;
        ...
        /// <summary>扩展方法索引：首参带 this 修饰的静态方法。</summary>
        ...
        internal CSharpBinder(bool isScript, BoundScope? parent, FunctionSymbol? function, ImmutableArray<string> references, ImmutableArray<string> usingNamespaces, Func<string, TypeSymbol?> builtinTypeResolver, ImmutableArray<string> usingStatics = default, ImmutableDictionary<string, string> usingAliases = null!, ImmutableArray<CoaProgram> codLibraries = default, NamespaceSymbol? globalNamespace = null)
        {
        ...
        public static BoundGlobalScope BindGlobalScope(bool isScript, BoundGlobalScope? previous, ImmutableArray<CoreSyntax.SyntaxTree> syntaxTrees, string entryPointName = "Main", string[]? references = null, ImmutableArray<CoaProgram> codLibraries = default)
        {
            ...
            // 阶段 1.4：using 命名空间解析警告（6e-M15）——在程序/引用/.coa 库中都找不到时发警告
...
// 阶段 4.5：绑定全局函数签名（类型可引用接口/类）
        ...
        /// </summary>
        internal static BoundBlockStatement BuildConstructorPrefix(CSharpBinder binder, FunctionSymbol function, CoreSyntax.SyntaxNode wrapSyntax, BoundBlockStatement body)
        {
