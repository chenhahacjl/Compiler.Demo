...
namespace Cocoa.CodeAnalysis.CSharp.Binding
{
    ...
    internal partial class CSharpBinder
    {
        ...
        {
            return _builtinTypeResolver(name);
        }
        ...
        private static FunctionSymbol? ResolveQualifiedEntryPoint(CSharpBinder binder, string entryPointName, TextLocation location)
        {
