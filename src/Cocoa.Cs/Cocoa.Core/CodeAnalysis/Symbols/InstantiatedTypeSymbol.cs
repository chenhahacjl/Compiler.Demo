...
namespace Cocoa.CodeAnalysis.Symbols
{
    ...
    /// </summary>
    public sealed class InstantiatedTypeSymbol : ClassTypeSymbol
    {
        private readonly object _gate = new();
        private bool _materialized;

        internal InstantiatedTypeSymbol(string name, string @namespace, Visibility visibility, ClassTypeSymbol genericDefinition, ImmutableArray<TypeSymbol> typeArguments)
        ...
        public ClassTypeSymbol GenericDefinition { get; }
