...
namespace Cocoa.CodeAnalysis
{
    ...
    public sealed class CocoaLanguage : Language
    {
        ...
        internal override (Binding.BoundBlockStatement Body, ImmutableArray<Diagnostic> Diagnostics) BuildFunctionBodyForMonomorphization(bool isScript, Binding.BoundScope parentScope, Symbols.FunctionSymbol function, Binding.BoundGlobalScope globalScope, System.Collections.Immutable.ImmutableArray<CocoaAssembly.CoaProgram> codLibraries, Dictionary<string, TypeSymbol> typeArgumentsByName)
