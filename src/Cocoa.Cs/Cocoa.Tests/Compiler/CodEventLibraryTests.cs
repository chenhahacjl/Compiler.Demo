...
");
            File.WriteAllText(Path.Combine(libDir, "GreeterLib.coproj"), @"<Project Version=""1"">
...
");
  ...
  <ItemGroup>
    <Source Include=""*.co"" />
    <Reference Include=""../GreeterLib/GreeterLib.coa"" />
  </ItemGroup>
</Project>
");

            var libProject = Path.Combine(libDir, "GreeterLib.coproj");
