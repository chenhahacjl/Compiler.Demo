...
namespace Cocoa.CodeAnalysis.Binding
{
    ...
    internal abstract class BoundNode
    {
        ...
        private static void PrettyPrint(TextWriter write, BoundNode node, string indent = "", bool isLast = true)
        {
        ...
        private static object GetText(BoundNode node)
        {
            ...
            {
                return binary.Op.Kind.ToString() + "Expression";
            }

            if (node is BoundUnaryExpression unary)
            {
                return unary.Op.Kind.ToString() + "Expression";
            }
        ...
        {
            if (node is BoundExpression) { return ConsoleColor.Blue; }
