...
> 关联：`docs-dev/archive/泛型设计.md`（G6 stdlib / G7 `.coa` 泛型序列化，本轮合并推进）、`docs-dev/archive/对象模型设计.md`（M4 native vtable 复用）、`docs/语法手册.md` §9.12/§15/§20、`docs-dev/archive/委托与Lambda设计.md`（M0-M6 分步设计）
